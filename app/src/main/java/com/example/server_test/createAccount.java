...
public class createAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        email = (EditText) findViewById(R.id.emailCreateAct);
        password = (EditText) findViewById(R.id.passwordCreateAct);
        createActBtn = (Button) findViewById(R.id.createActButton);
                    ...
                    .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                        ...
                        public void onSuccess(AuthResult authResult) {
                            if(authResult != null){
                                ...
                                currentUserDb.child("somethingnew").setValue("hello");

                                mProgressDialog.dismiss();

                                //send users to postList
                                Intent in = new Intent(new Intent(createAccount.this, Login.class));
